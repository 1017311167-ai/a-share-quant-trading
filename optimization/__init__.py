...
def optimize_parameters(df, strategy_name, param_ranges, metric: str = "夏普比率",
    ...
    if record_experiment:
        ...
        costs = CostAssumptions(
            ...
            commission_min=kwargs.get("commission_min", 5.0),
            slippage=kwargs.get("slippage", 0.001),
            impact_coefficient=kwargs.get("impact_coefficient", 0.02),
            max_slippage=kwargs.get("max_slippage", 0.05),
            participation_rate=kwargs.get("participation_rate", 0.05),
            lot_size=kwargs.get("trade_unit", 100),
            ...
            limit_queue_fill_ratio=kwargs.get("limit_queue_fill_ratio", 0.25),
            order_ttl_bars=kwargs.get("order_ttl_bars", 5),
            execution_model=kwargs.get("execution_model", "realistic"),
